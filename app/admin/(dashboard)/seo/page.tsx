...
const PAGES: SeoRow[] = [
  ...
  { pageKey: 'about', label: 'About Us', path: '/about', defaultTitle: 'About Distress Deals Dubai | Verified Distressed Sales', defaultDescription: 'How Distress Deals Dubai sources verified distressed and below-market property across the UAE.' },
  { pageKey: 'contact', label: 'Contact Us', path: '/contact', defaultTitle: 'Contact Us | Distress Deals Dubai', defaultDescription: 'Get in touch with Distress Deals Dubai — questions about buying, selling, or a specific listing.' },
  ...
  { pageKey: 'privacy', label: 'Privacy Policy', path: '/privacy', defaultTitle: 'Privacy Policy | Distress Deals Dubai', defaultDescription: 'How Distress Deals Dubai collects, uses, and protects your personal information.' },
  { pageKey: 'terms', label: 'Terms of Service', path: '/terms', defaultTitle: 'Terms of Service | Distress Deals Dubai', defaultDescription: 'The terms that govern your use of the Distress Deals Dubai website and mobile app.' },
  { pageKey: 'cookies', label: 'Cookie Policy', path: '/cookies', defaultTitle: 'Cookie Policy | Distress Deals Dubai', defaultDescription: 'How Distress Deals Dubai uses cookies, local storage, and analytics tools.' },
  { pageKey: 'sitemap', label: 'Sitemap Page', path: '/sitemap', defaultTitle: 'Sitemap | Distress Deals Dubai', defaultDescription: 'Every section of Distress Deals Dubai in one place.' },
]
